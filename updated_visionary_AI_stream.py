...
#                logging.error("Permission denied, retrying in 5 seconds...")
#                time.sleep(4)
#            else:
...
#                playsound.playsound(current_audio)
#            else:
#                logging.error(f"Cannot find a sound with filename: {current_audio}")
...
#                "parts": [
#                    {
#                        "text": "Explain what you see in this image with any texts or words to read below 10 words"
#                    },
#                    {
#                        "inline_data": {
...
#                logging.info("Saving photo.")
#
#                encoded_image = encode_image(path)
#                logging.info(f"Encoded image: {encoded_image[:30]}...")
#
#                if not encoded_image:
#                    logging.error("Failed to encode image. Retrying in 5 seconds...")
#                    time.sleep(4)
#                    continue
#                
#                response_text = analyze_image(encoded_image, script)
#                logging.info(f"HearSight's response: {response_text}")
#
...
#                    logging.info(f"Translated response: {response_text}")
#
...
#
## Path to the language file
#LANGUAGE_FILE_PATH = '/home/rock/Desktop/HS/env/lang.txt'
#
#LANGUAGE_MAPPING = {
#    'Tamil': 'ta',
#    'English': 'en',
...
#    duration_in_seconds = len(audio) / 2000  # Convert milliseconds to seconds
#    return duration_in_seconds
#
#def play_audio_func(speed = 2.0):
#    global audio_playing
#    current_audio = "/home/rock/Desktop/HS/visionary_ai_stream/voice_current.mp3"
#    next_audio = "/home/rock/Desktop/HS/visionary_ai_stream/voice_next.mp3"
#    while True:
...
#                "parts": [
#                    {
#                        "text": "Explain what you see in this image along with any texts or words or numbers and give it below 10 words"
#                    },
#                    {
#                        "inline_data": {
#                            "mime_type": "image/jpeg",
...
def translate_text(text, target_language):
    ...
    try:
        ...
        translated = translator.translate(text, dest=target_language)
        logging.info(f"Translated text: {translated.text if translated else 'Translation failed'}")
        return translated.text if translated else text
    except AttributeError as e:
        logging.error(f"AttributeError: {e} - Response may be malformed or missing attributes.")
        return text
    except Exception as e:
        logging.error(f"Error translating text: {e}")
        return text  # Return original text if translation fails
